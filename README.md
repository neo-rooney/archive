...
1. Javascript Deep Dive 1회독(1/2)
2. 알고리즘 문제 꾸준히 풀기(하루 최소 1문제, 인프런 JS 알고리즘 강의 활용)
3. 출퇴근 시간 활용 계획(프론트엔드 팁 같은 가벼운 강의 위주로 학습 / 퇴근에는 개발서적 읽기)
4. 주말에는 코드를 짜는 학습 위주로 진행(클론코딩, 유튜브 애니메이션 따라하기, Three.js 등)
# 2021/10/29/FRI TIL
## Project 
### 시간표 어플리케이션 
1. 기능 구성 정리
...
## Javascript 
### Javascript Deep Dive
1. 11장 원시타입과 객체타입의 차이(137p ~ 153p)
## ETC
### Refectoring 2판
1. 6장 강의
2. 158p - 178p읽기
