...
function () {
  ...
  regeneratorRuntime.mark(function _callee6(req, res) {
    var id, _req$body2, title1111, description1111;

    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            id = req.params.id, _req$body2 = req.body, title1111 = _req$body2.title1111, description1111 = _req$body2.description1111;
...
function () {
  ...
  regeneratorRuntime.mark(function _callee9(req, res) {
    var id, comment123, user, video, newComment;
    return regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            id = req.params.id, comment123 = req.body.comment123, user = req.user;
            console.log(req.body);
            _context9.prev = 2;
            _context9.next = 5;
            return _Video["default"].findById(id);
