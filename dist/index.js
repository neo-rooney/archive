...
var _excluded = ["theme", "layoutMode", "label"];
...
var Button = function Button(_ref) {
  var theme = _ref.theme,
      ...
      layoutMode = _ref$layoutMode === void 0 ? "inline" : _ref$layoutMode,
      label = _ref.label,
...
var themes = {
  primary: css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    background: ", ";\n    color: white;\n    &:hover {\n      background: #38d9a9;\n    }\n    &:active {\n      background: #12b886;\n    }\n  "])), colors.primary),
  secondary: css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    background: ", ";\n    color: white;\n    &:hover {\n      background: #f1f3f5;\n    }\n    &:active {\n      background: #dee2e6;\n    }\n  "])), colors.secondary),
  tertiary: css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n    background: ", ";\n    color: white;\n    &:hover {\n      background: #e6fcf5;\n    }\n    &:active {\n      background: #c3fae8;\n    }\n  "])), colors.tertiary)
};
var layoutModes = {
  inline: css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([""]))),
  fullWidth: css(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n    width: 100%;\n  "])))
};
